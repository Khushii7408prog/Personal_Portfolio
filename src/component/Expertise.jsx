            ...
            <div className="py-14 bg-gray-50">
                ...
                <div className="container mx-auto px-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <button
                            className="bg-blue-500 text-white py-2 px-6 rounded-full hover:bg-white hover:text-blue-500 border-2 border-blue-500 transition-colors duration-300 hover:cursor-pointer"
                        >
                            Hire Me
                        </button>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-center">
                        <div className="bg-white p-6 rounded-lg shadow-lg hover:text-blue-500 transition-colors duration-300">
